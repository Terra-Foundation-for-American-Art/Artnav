<!--
*** PULLED FROM NON-STABLE RELEASE OF:
*** https://github.com/mauricius/vue-draggable-resizable/tree/20a9b1c2b40c8f8076761c578a26e0ce4a0b6e3f
*** commit: 20a9b1c
*** Description: This semi-tested commit has watcher handlers
    for initial X and Y positions, making them dynamic properties
-->

<template>
  <div v-if="resizable" class="vdr" :class="{ draggable: draggable, resizable: resizable, active: active }" @mousedown="elmDown" @dblclick="fillParent" :style="style">
    <div
      class="handle"
